...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Widget _buildCloudToggle(BuildContext context, ReportProvider reportProvider) {
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
    final value = reportProvider.useCloud;

    return GestureDetector(
      onTap: () {
        reportProvider.setUseCloud(!value);
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Row(
              children: [
                Icon(
                  !value ? Icons.cloud_queue_rounded : Icons.storage_rounded,
                  color: Colors.white,
                  size: 18,
                ),
                ...
                Text(
                  !value
                      ? "Bulutli hisobotlar rejimi faollashtirildi"
                      : "Lokal hisobotlar rejimi faollashtirildi",
                  style: const TextStyle(fontWeight: FontWeight.w600),
                ),
              ],
            ),
            backgroundColor: !value ? Colors.indigo : Colors.blueGrey,
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            gradient: value
                ...
                : LinearGradient(
                    colors: isDark
                        ? [Colors.white.withValues(alpha: 0.05), Colors.white.withValues(alpha: 0.08)]
          ...
          child: Row(
            ...
            children: [
              AnimatedRotation(
                ...
                child: Icon(
                  value ? Icons.cloud_done_rounded : Icons.cloud_queue_rounded,
                  color: value ? Colors.white : (isDark ? Colors.white70 : const Color(0xFF475569)),
                  size: 15,
                ),
              ),
